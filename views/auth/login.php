...
<div class="max-w-md mx-auto">
  <div class="glass rounded-2xl shadow-lg overflow-hidden mb-6">
    <div class="px-6 py-8 text-center border-b border-white/10">
      <h2 class="text-2xl font-medium text-white mb-2">Welcome Back!</h2>
      <p class="text-white/80 font-light">Log in to track your protein intake</p>
    </div>
    ...
    <div class="p-6">
      ...
      <div class="mt-6 text-center">
        <p class="text-white/80 font-light">Don't have an account? <a href="/register" class="text-white hover:text-white/80 transition duration-200">Register</a></p>
      </div>
    </div>
  </div>
</div>
